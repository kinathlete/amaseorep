 ...
 */
@WebServlet("/GetAllProfiles")
public class GetAllProfiles extends HttpServlet {
...
//		String specificProfileId = " AND amaseoAccount = 'comAmazon'";
		...
		try {
			...
			rs = stmt.executeQuery("SELECT profileId,targetAcos, sellerName, marketplace, amaseoAccount, kam, comments FROM Clients WHERE (status <> 'deleted' OR status IS null)" + specificProfileId);
